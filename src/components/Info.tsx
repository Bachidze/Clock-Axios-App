  ...
  return (
    <div>
        <div className='w-[100px] h-[35px] rounded-[20px] md:ml-[64px] md:w-[156px] md:h-[56px]  bg-[white] ml-4 flex justify-end items-center pr-1 mt-[90px] mb-[35px] xl:ml-[116px] xl:text-[25px] xl:relative xl:left-[70%] dark:bg-black'>
          <h3 className='pr-[7px] text-[gray] text-[14px] md:text-[16px] md:font-bold md:pr-[18px] dark:text-white'>MORE</h3>
          ...
          onClick={()=>setGaqroba(!gaqroba)}>
            <FontAwesomeIcon className={`transform ${rotate ? 'rotate-180' : 'rotate-0'} text-white transition duration-1000 dark:text-black`}
             icon={faChevronDown} 
             onClick={rotateIcon}
             />
          </div>
